...
# Generated by qmake (3.0) (Qt 5.1.0) on: Tue Dec 3 23:36:24 2013
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) obj/harbour-sailshotme1.0.0/ && $(COPY_FILE) --parents src/harbour-sailshotme.cpp obj/harbour-sailshotme1.0.0/ && (cd `dirname obj/harbour-sailshotme1.0.0` && $(TAR) harbour-sailshotme1.0.0.tar harbour-sailshotme1.0.0 && $(COMPRESS) harbour-sailshotme1.0.0.tar) && $(MOVE) `dirname obj/harbour-sailshotme1.0.0`/harbour-sailshotme1.0.0.tar.gz . && $(DEL_FILE) -r obj/harbour-sailshotme1.0.0
